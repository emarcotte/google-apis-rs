...
///     ).build().await.unwrap();
/// let mut hub = ServiceBroker::new(hyper::Client::builder().build(hyper_rustls::HttpsConnectorBuilder::new().with_native_roots().https_or_http().enable_http1().build()), auth);
...
impl<'a, S> ServiceBroker<S> {
    ...
    pub fn new<A: 'static + client::GetToken>(client: hyper::Client<S, hyper::body::Body>, auth: A) -> ServiceBroker<S> {
        ServiceBroker {
            client,
            auth: Box::new(auth),
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleIamV1__Policy)> {
        ...
        dlg.begin(client::MethodInfo { id: "servicebroker.getIamPolicy",
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleIamV1__Policy)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "servicebroker.setIamPolicy",
...
/// # extern crate hyper_rustls;
/// # extern crate google_servicebroker1 as servicebroker1;
/// use servicebroker1::api::GoogleIamV1__TestIamPermissionsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use servicebroker1::{ServiceBroker, oauth2, hyper, hyper_rustls, chrono, FieldMask};
/// 
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleIamV1__TestIamPermissionsResponse)> {
        ...
        let mut dd = client::DefaultDelegate;
        let mut dlg: &mut dyn client::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(client::MethodInfo { id: "servicebroker.testIamPermissions",
                               http_method: hyper::Method::POST });
