...
impl client::Part for UserOwnedDrydockNote {}
...
/// # extern crate hyper_rustls;
/// # extern crate google_binaryauthorization1_beta1 as binaryauthorization1_beta1;
/// use binaryauthorization1_beta1::api::Attestor;
/// # async fn dox() {
/// # use std::default::Default;
/// # use binaryauthorization1_beta1::{BinaryAuthorization, oauth2, hyper, hyper_rustls, chrono, FieldMask};
/// 
...
/// # extern crate hyper_rustls;
/// # extern crate google_binaryauthorization1_beta1 as binaryauthorization1_beta1;
/// use binaryauthorization1_beta1::api::SetIamPolicyRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use binaryauthorization1_beta1::{BinaryAuthorization, oauth2, hyper, hyper_rustls, chrono, FieldMask};
/// 
...
/// # extern crate hyper_rustls;
/// # extern crate google_binaryauthorization1_beta1 as binaryauthorization1_beta1;
/// use binaryauthorization1_beta1::api::TestIamPermissionsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use binaryauthorization1_beta1::{BinaryAuthorization, oauth2, hyper, hyper_rustls, chrono, FieldMask};
/// 
...
/// # extern crate hyper_rustls;
/// # extern crate google_binaryauthorization1_beta1 as binaryauthorization1_beta1;
/// use binaryauthorization1_beta1::api::ValidateAttestationOccurrenceRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use binaryauthorization1_beta1::{BinaryAuthorization, oauth2, hyper, hyper_rustls, chrono, FieldMask};
/// 
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ValidateAttestationOccurrenceResponse)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1beta1/{+attestor}:validateAttestationOccurrence";
        if self._scopes.is_empty() {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_binaryauthorization1_beta1 as binaryauthorization1_beta1;
/// use binaryauthorization1_beta1::api::Policy;
/// # async fn dox() {
/// # use std::default::Default;
/// # use binaryauthorization1_beta1::{BinaryAuthorization, oauth2, hyper, hyper_rustls, chrono, FieldMask};
/// 
